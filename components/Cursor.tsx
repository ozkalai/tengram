...
const YourCursor = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`px-4 py-2 m-2 bg-clip-text text-transperent ${nameColor} rounded-full text-sm whitespace-nowrap`}
      >
        You
      </div>
    </div>
      ...
      {otherUsers.map(({ connectionId, profileData }) => {
        ...
        return (
          ...
          >
            <CursorSvg cursorColor={cursorColor} />
            <div
              className={`px-4 py-2 m-2 bg-clip-text text-transperent ${nameColor} rounded-full text-sm whitespace-nowrap member-cursor`}
            >
              {profileData.name}
            </div>
          </div>
